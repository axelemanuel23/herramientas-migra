...
const VisaRegime = () => {
  ...
  const obs = [
    ...
    { pais: "HONG KONG con Pte. Británico B.N.O.", codigo: "GBN", texto: "B.N.O. (BRITISH NATIONAL OVERSEAS) NO REQUIERE VISA EN PASAPORTES COMUNES POR TURISMO, NEGOCIOS Y ARTÍSTICAS HASTA TREINTA (30) DÍAS", textoaaclarar: "TREINTA (30) DÍAS", aclaracion: "RTU 30 DIAS" },

...
const VisaRegime = () => {
  ...
  const obs = [
    ...
    { pais: "BULGARIA", codigo: "BGR", texto: " 90 DIAS EN 180 DIAS", textoaaclarar: "90 DIAS EN 180 DIAS", aclaracion: "Se descuentan los dias que permanecio en el pais durante ese período" },
    { pais: "FEDERACION RUSA (RUSIA)", codigo: "RUS", texto: " 90 DIAS EN 180 DIAS", textoaaclarar: "90 DIAS EN 180 DIAS", aclaracion: "Se descuentan los dias que permanecio en el pais durante ese período" },
    { pais: "BIELORRUSIA", codigo: "BLR", texto: " 90 DIAS EN 1 AÑO", textoaaclarar: "90 DIAS EN 1 AÑO", aclaracion: "Se descuentan los dias que permanecio en el pais durante ese período" },
    { pais: "GEORGIA", codigo: "GEO", texto: " 90 DIAS EN 180 DIAS", textoaaclarar: "90 DIAS EN 180 DIAS", aclaracion: "Se descuentan los dias que permanecio en el pais durante ese período" },
    { pais: "INDONESIA", codigo: "IDN", texto: " 30 DIAS RTU", textoaaclarar: "30 DIAS RTU", aclaracion: "Permanencia otorgada en cada ingreso" },
    { pais: "MACAO", codigo: "MAC", texto: "La Región Administrativa Especial de Macao de la República Popular China estarán exentos de los requisitos de visado para ingresar, salir y transitar por el territorio de la República Argentina y el área de la Región Administrativa Especial de Macao de la República Popular China, respectivamente, por razones de turismo o de negocios por períodos de treinta (30) días corridos, contados desde la fecha de ingreso", textoaaclarar: "(30) días corridos", aclaracion: "CATEGORIA RTU 30 DIAS EN CADA INGRESO" },
